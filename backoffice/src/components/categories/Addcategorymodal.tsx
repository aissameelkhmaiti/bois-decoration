...
import { createCategory, fetchCategories } from '../../redux/categoriesSlice';
          ...
          >
            ...
            <div className="relative px-10 pt-10 pb-6">
              ...
              <div className="flex justify-between items-start">
                <div>
                  <h2 className="text-3xl font-black text-gray-900 tracking-tight">Nouvelle Catégorie</h2>
                  <p className="text-gray-500 mt-1 font-medium">Ajoutez une nouvelle catégorie de projet.</p>
                </div>
