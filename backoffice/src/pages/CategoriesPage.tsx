...
// --- Variantes d'animation (identiques à ProjectsPage) ---
    ...
    >
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left border-collapse">
            <thead className="bg-[#fdfaf9] border-b border-gray-100">
              <tr>
                <th className="px-6 py-5 text-[#A66D3B] font-bold text-sm uppercase tracking-wider">Nom de la Catégorie</th>
                <th className="px-6 py-5 text-[#A66D3B] font-bold text-sm uppercase tracking-wider">Description</th>
                  ...
                  {categories.map((cat: Category) => (
                    ...
                    >
                      ...
                      <td className="px-6 py-4">
                        <span className="bg-gray-100 px-3 py-1 rounded-lg text-xs font-mono text-gray-600 border border-gray-200">
                          {cat.description || '—'}
                        </span>
                      </td>
                      <td className="px-6 py-4">
      ...
      {status === 'failed' && (
        <motion.div 
          ...
          className="mt-4 p-4 bg-red-50 text-red-600 rounded-xl text-center font-medium border border-red-100"
        >
          Erreur : {error}
        </motion.div>
      )}
